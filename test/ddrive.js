...
// This test no longer relevant (daemon internals have changed).
...
// This test is no longer relevant (daemon internals have changed).
...
test.skip('drives are writable after a daemon restart', async t => {
